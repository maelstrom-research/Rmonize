...
See the [Glossary](../articles/a-Glossary-and-templates.html) and 
[Reference](../reference/index.html) pages for more details about the terms used in 
this document.
...
[Rmonize_DEMO](../reference/Rmonize_DEMO.html) object. They include example 
...
[templates](../articles/a-Glossary-and-templates.html) and imported into R. 
...
[data_dict_apply()](../reference/data_dict_apply.html). If not provided, minimal
...
For use in [harmo_process()](../reference/harmo_process.html), one or more input 
...
[dossier_create()](../reference/dossier_create.html).
...
processing using [harmo_process()](../reference/harmo_process.html), which uses 
...
[show_harmo_error()](../reference/show_harmo_error.html).
...
[harmonized_dossier_evaluate()](../reference/harmonized_dossier_evaluate.html) and
[harmonized_dossier_summarize()](../reference/harmonized_dossier_summarize.html), 
...
A visual report with summary figures for each variable can also be produced using [harmonized_dossier_visualize()](../reference/harmonized_dossier_visualize.html). 
...
[pooled_harmonized_dataset_create()](../reference/pooled_harmonized_dataset_create.html).
...
[data_dict_extract()](../reference/data_dict_extract.html).
