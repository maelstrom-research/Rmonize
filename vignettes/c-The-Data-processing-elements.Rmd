...
## Example 1 : initialization of the harmonization with the DataSchema variable adm_unique_id (mandatory)
...
## Example 2 : harmonization of the DataSchema variable sdc_gender
...
::: {class="image-container-big"}
  <img src="../man/figures/sdc_gender_var.png" style="max-width: 100%; height: auto;">
  
  <br>
  
  <img src="../man/figures/sdc_gender_cat.png" style="max-width: 100%; height: auto;">
:::
...
**2 Identidy for each dataset which column (variable) will be associated to the
harmonization script to generate the harmonzed variable.**
...
**Warning ⚠** In your environnement, additional objects must exist:
...
[See the whole process of harmonization through a DEMO](d-Example-with-DEMO-files.html)


## Understanding the output : how to detect and correct errors.

If the process of harmonization produces errors in R, the process will not generate
...
and analyse very closely, because they may refer to errors. A common warning generated
