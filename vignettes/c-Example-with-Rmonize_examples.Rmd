---
title: "Example with Rmonize_examples"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example with Rmonize_examples}
...
Example objects included with the package. The vignette focuses on illustrating 
...
# Example objects
Example objects are available through the built-in 
[Rmonize_examples](https://maelstrom-research.github.io/Rmonize-documentation/reference/Rmonize_examples.html) 
...
<em>
Note: In the example DPEs, all elements for three different input datasets are 
